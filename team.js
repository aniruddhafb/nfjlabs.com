...
const configuration = {
    ...
    colors: {
        ...
        LettersColor: '#8C52FF',
        LinesColors: ['#FFF', '#DB261D', '#7d7d7d'],
        LowerLinesColors: ['#8C52FF'],
        DotsColor: '#E2DFD2'
    }
}
///////////////////////////////
...
function loadMainLetters() {
    ...
    fontLoader.load('resources/fonts/Roboto-Black-3d.json', font => {
        ...
        for (let i = 0; i < configuration.NumberOfJews; i++) {
            let x = Math.random() * 200 - 100
            let y = Math.random() * 200 - 100
            let z = Math.random() * 200 - 100
        ...
        for (let i = 0; i < configuration.NumberOfRings; i++) {
            let x = Math.random() * 200 - 100
            let y = Math.random() * 200 - 100
            let z = Math.random() * 200 - 100
        ...
        // const pointSprite = new THREE.TextureLoader().load('resources/images/icons/pointImg.mp4')
        ...
        // const pointSprite2 = new THREE.TextureLoader().load('resources/images/icons/necklace.png')
        // // const pointSprite = new THREE.TextureLoader().load('resources/images/icons/pointImg.mp4')
        // const pointsMaterial2 = new THREE.PointsMaterial({ color: configuration.colors.DotsColor, size: 0.5, map: pointSprite2, transparent: true, alphaTest: 0.5 })
        // const points2 = new THREE.Points(bufferGeometry2, pointsMaterial2)
        // scene.add(points2)

        // const bufferGeometry3 = new THREE.BufferGeometry()
        // bufferGeometry3.setAttribute('position', new THREE.Float32BufferAttribute(vertices3, 3))
        // const pointSprite3 = new THREE.TextureLoader().load('resources/images/icons/ring.png')
        // // const pointSprite = new THREE.TextureLoader().load('resources/images/icons/pointImg.mp4')
        // const pointsMaterial3 = new THREE.PointsMaterial({ color: configuration.colors.DotsColor, size: 0.5, map: pointSprite3, transparent: true, alphaTest: 0.5 })
        // const points3 = new THREE.Points(bufferGeometry3, pointsMaterial3)
        // scene.add(points3)
...
function windowWheelOrTouch(e) {
    ...
    if (e.deltaY > 0 || (e.touches && e.touches[0].pageY < touchStartPosition)) {
        ...
        sceneMovedAmmount++
        sceneMovedAmmount = Math.min(sceneMovedAmmount, 0)
        moveScene()
